...
class NewProductPageMobile extends StatefulWidget {
  const NewProductPageMobile({super.key, required this.presenter});
  final NewProductPresenter presenter;

  @override
  NewProductPageMobileState createState() => NewProductPageMobileState();
}

class NewProductPageMobileState extends State<NewProductPageMobile> {
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.only(bottom: heightPercent(4, context)),
                    child: SizedBox(
